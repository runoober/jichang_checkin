# 机场签到😍<br/>
> 默认只运行auto_check_in_ikuuu.py
>
> 
>main.py脚本只要机场网站''' Powered by SSPANEL ''',就可以进行签到。要确认是否是''' Powered by SSPANEL '''，在机场首页滑倒最底端就可以看到。例如：
...
>
>**auto_check_in_ikuuu.py**脚本只适用于ikuuu机场
## 作用
>每天进行签到，获取额外的流量奖励

## 推送方式
  - 🚀🚀auto_check_in_ikuuu.py脚本采用的是青龙面板
  - main.py脚本采用的是<a href = 'https://sct.ftqq.com/r/5126'>Server酱</a>的推送方式，如果不需要推送，就下面的SCKEY参数的值设置为<b>空</b>就行
